...
IDTxl - Information Dynamics Library for Python with JIDT implementation (JAVA based) (Explore IDTxl as python implementation in MATLAB was possible by using *pyenv* function
